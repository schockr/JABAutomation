...
namespace JABAutomation
{
    public class JABBase : IDisposable, IJavaDriver, ISearchContext
    {
        ...
        public Point FindTableCellElementByName(IJavaElement table, string cellName, int colIndex = -1, int rowIndex = -1)
        {
            Point point = table.TableInfo.GetTableRowCoordinates(cellName, colIndex, rowIndex);
